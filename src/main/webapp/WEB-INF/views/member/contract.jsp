...
<body>
	...
	<h2 style="margin-top:2em; margin-left:3.8em;">이용약관 동의</h2><br>
	<div class="row aln-center">
	<div style="float:center; width:80%; margin-bottom:3em;">
	<form id="join" action="join_form" method="post" name="formm">
		<span><b>1. 이용약관 동의(필수)</b></span>
		<textarea rows="13" cols="80">
제1조(목적)
이 약관은 Sunny Flea Market (전자상거래 사업자)가 운영하는 Sunny Flea Market  사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.
...
위의 내용들은 '전자상거래 등에서의 소비자보호에 관한 법률' 제 17조
- 소비자의 사용 또는 일부 소비에 의하여 재화등의 가치가 현저히 감소한 경우 ( 재판매가 불가능한 경우가 해당합니다.)
- 복제가 가능한 재화등의 포장을 훼손한 경우 ( 상품의 택을 제거한 경우가 해당합니다.)
에는 통신판매업자의 의사에 반하여  규정에 의한 청약철회등을 할 수 없다.
이는 법률에 의거한 것으로 Sunny Flea Market 에서는 청약철회를 거절할 수 있습니다.
즉, 주문 제작 방식으로 반품 후 재판매가 불가능한 경우에 단순히 소비자의 변심에 의한 반품 요구에 응할 의무는 없으며, 물건에 하자가 있는 경우에는 소비자 피해보상규정에 따라 교환 또는, 수리, 구입가 환급 등을 하도록 정해져 있습니다.
		</textarea>
		<input type="radio" name="okon1" class="agree1" checked> 동의함&nbsp; &nbsp; &nbsp; 
		<input type="radio" name="okon1" class="agree1"	checked> 동의안함
		<br><br>
		<span><b>2. 개인정보 수집 및 이용 동의(필수)</b></span>
		<textarea rows="13" cols="80">
■ 수집하는 개인정보 항목
회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.

ο 수집항목 : 이름 , 로그인ID , 비밀번호 , 주소 , 휴대전화번호 , 이메일 , 서비스 이용기록 , 접속 로그 , 쿠키 , 접속 IP 정보 , 결제기록
...
또한 위탁계약시 개인정보보호의 안전을 기하기 위하여 개인정보보호 관련법규의 준수. 개인정보에 관한 제3자 공급 금지, 사고시의 책임부담 등을 명확히규정하고 있습니다. 향후 동업체가 변경될 경우, 위탁 대상자와 위탁 업무 내용에 대해 고객님에게 통지하고 필요한 경우 사전 동의를 받도록 하겠습니다.
		</textarea>
		<input type="radio" name="okon2" class="agree2" checked> 동의함&nbsp; &nbsp; &nbsp; 
		<input type="radio" name="okon2" class="agree2"	checked> 동의안함 <br>
		<br>
